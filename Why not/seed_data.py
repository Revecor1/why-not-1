...
menu_items = [
    ...
    {'category': 'coffee', 'name': 'Раф кофе',         'description': 'Взбитый кофе со сливками. Нежный и воздушный.',                                'price': 310, 'image': 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=500&q=80'},
    ...
    {'category': 'drinks', 'name': 'Лавандовый Раф',   'description': 'Нежнейший кофейно-сливочный десерт с цветами лаванды.',                        'price': 320, 'image': 'https://images.unsplash.com/photo-1558562805-4bf1e2a724eb?w=500&q=80'},
    {'category': 'drinks', 'name': 'Бамбл-Кофе',       'description': 'Освежающий микс эспрессо, апельсинового сока и карамели.',                     'price': 310, 'image': 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=500&q=80'},
    {'category': 'drinks', 'name': 'Айс-Латте Карамель','description': 'Холодный кофе с домашней карамелью и морской солью.',                         'price': 330, 'image': 'https://images.unsplash.com/photo-1517701604599-bb24b5e50dd2?w=500&q=80'},
    ...
    # --- Завтраки ---
    {'category': 'breakfasts', 'name': 'Завтрак с лососем',    'description': 'Слабосоленый лосось, яйцо пашот, авокадо, микс салата и тартин.',       'price': 650, 'image': 'https://images.unsplash.com/photo-1627844026364-70a2569de091?w=500&q=80'},
    ...
    {'category': 'breakfasts', 'name': 'Сырники из творога',   'description': 'Подаются со сметаной и ягодным кули. Вкус как в детстве.',               'price': 340, 'image': 'https://images.unsplash.com/photo-1559598467-f8b76c8155d0?w=500&q=80'},
    ...
    {'category': 'food', 'name': 'Тёплый салат',        'description': 'Микс салата, бекон, черри, золотистый картофель и яйцо пашот.',                'price': 410, 'image': 'https://images.unsplash.com/photo-1550304943-4f24f54ddde9?w=500&q=80'},
    ...
    {'category': 'food', 'name': 'Цезарь с индейкой',   'description': 'Классический соус, хрустящие сухарики, пармезан и сочная грудка.',             'price': 390, 'image': 'https://images.unsplash.com/photo-1550304943-4f24f54ddde9?w=500&q=80'},
    ...
    {'category': 'desserts', 'name': 'Круассан классический', 'description': 'Свежеиспечённый, хрустящий, со сливочным ароматом.',                     'price': 180, 'image': 'https://images.unsplash.com/photo-1555507036-ab1f40ce88cb?w=500&q=80'},
...
print(f"  ✅ Добавлено {created_count} новых позиций меню (всего: {MenuItem.objects.count()})")
